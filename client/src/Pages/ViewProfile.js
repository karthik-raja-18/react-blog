...
const ViewProfilePage = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/users/update/${userDetails.username}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      ...
      {loading ? (
        ...
        <div className="profileDetails">
          ...
          {userDetails.profileImage && (
            <img src={`${process.env.REACT_APP_API_URL}/uploads/${userDetails.profileImage}`} alt="Profile" />
          )}
